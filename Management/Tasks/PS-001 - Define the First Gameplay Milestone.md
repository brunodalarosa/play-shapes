...
- Which minigame idea best represents Play Shapes for the first gameplay proof?
- How many simultaneous players must the first gameplay milestone support?
- Should the lobby playground participate in the first playable loop or remain a join screen?
- Which interactions must work with one thumb?
- What duration should a round and a complete local session feel like?
