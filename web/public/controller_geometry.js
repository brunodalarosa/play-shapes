export function heldDirectionAfterUpdate(held, available) {
    return held !== undefined && available.includes(held) ? held : undefined;
}
export function directionAtPoint(count, x, y, width, height) {
...
export function chargedColor(hex, minimum, maximum, charge) {
