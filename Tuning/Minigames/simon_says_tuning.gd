...
@export_range(0.1, 3.0, 0.05, "suffix:s") var charge_fill_seconds: float = 1.0:
...
@export_range(0.05, 1.0, 0.01, "suffix:s") var charge_decay_seconds: float = 0.28:
...
@export_range(0.1, 3.0, 0.05, "suffix: beats/s") var dance_beats_per_second: float = 1.7:
...
@export_range(0.0, 16.0, 0.5, "suffix: px") var body_bounce: float = 6.0:
...
@export_range(0.0, 12.0, 0.5, "suffix:°") var body_jiggle_degrees: float = 4.0:
...
@export_range(0.0, 16.0, 0.5, "suffix: px") var body_sway: float = 7.0:
...
@export_range(1.0, 30.0, 0.5, "suffix: charge/s") var visual_follow_speed: float = 12.0:
...
@export_range(0.5, 5.0, 0.1, "suffix:s") var auto_hold_seconds: float = 1.5:
...
@export_range(0.1, 2.0, 0.1, "suffix:s") var auto_release_seconds: float = 0.7:
